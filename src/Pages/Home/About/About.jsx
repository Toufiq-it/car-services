...
const About = () => {
    return (
        <div className="hero min-h-screen bg-base-100 p-4">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className="lg:w-1/2 space-y-5">
                    ...
                    <button className="btn btn-error bg-[#FF3811] rounded-none px-10 text-white normal-case">Get More Info</button>
                </div>
            </div>
        </div>
    );
